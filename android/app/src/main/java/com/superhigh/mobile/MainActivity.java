...
public class MainActivity extends BridgeActivity {
    ...
    private MobileApkUpdater apkUpdater;
    ...
    protected void load() {
        ...
        apkUpdater = new MobileApkUpdater(this, webView);
        webView.addJavascriptInterface(apkUpdater, "SuperHighApkUpdate");
        super.load();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == MobileApkUpdater.INSTALL_PERMISSION_REQUEST) {
            if (apkUpdater != null) apkUpdater.permissionResult();
            return;
        }
    ...
    public void onDestroy() {
        if (apkUpdater != null) apkUpdater.close();
        voiceRequestId = null;
        voicePageUrl = null;
        ...
        if (bridge != null) bridge.getWebView().removeJavascriptInterface("SuperHighApkUpdate");
        super.onDestroy();
    }
}
