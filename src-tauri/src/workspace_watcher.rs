...
const WATCHABLE_SUPERHIGH_PREFIXES: &[&str] = &[".superhigh/cards/"];
...
impl WorkspaceWatcherManager {
    ...
    pub fn sync_targets(
        ...
        for (root_path, (root, directories)) in &next_targets {
