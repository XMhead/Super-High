...
use fs_ops::{
    ...
    delete_path, ensure_dragon_core, list_directory, move_paths_to_directory, normalize_path,
    ...
    search_project_files, validate_video_for_preview, write_dragon_output_data_url,
    write_text_file,
};
...
use models::{
    ...
    DragonCoreInfo, EndpointLatencyResult, FetchedModel, MemoRecord, MobileHostConfig,
...
#[tauri::command]
fn ensure_dragon_core_command() -> Result<DragonCoreInfo, String> {
    ensure_dragon_core().map_err(|error| error.to_string())
}

#[tauri::command]
fn export_dragon_image_command(
    data_url: String,
    output_file_name: Option<String>,
) -> Result<String, String> {
    write_dragon_output_data_url(&data_url, output_file_name.as_deref())
        .map_err(|error| error.to_string())
}
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            ensure_dragon_core_command,
            export_dragon_image_command,
