...
fn dispatch(args: &[String], stdout: &mut dyn Write) -> Result<()> {
    ...
    match command.as_str() {
        "dragon" => crate::cli_dragon::handle_dragon(&mut args, stdout),
...
Usage:
  superhigh-cli dragon <ensure|export-data-url> ...
  ...
  superhigh-cli terminal <list|logs> ...
  superhigh-cli tools <list|run> ...

Options:
  --json            All commands support machine-readable JSON.
  --project <path>  Supported by dragon/items/memory/search/service/terminal/tools.
