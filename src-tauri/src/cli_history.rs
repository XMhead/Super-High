...
mod tests {
    ...
    fn extracts_claude_human_prompt_and_skips_tool_results() {
        let claude = serde_json::json!({
            ...
            "cwd": r"D:\示例项目\示例项目目录名服务端\plugins",
            "origin": { "kind": "human" },
    ...
    fn indexes_claude_and_codex_sessions_and_keeps_cwd_paths() {
        ...
        let cwd = r"D:\示例项目\示例项目目录名服务端\plugins";
        write(
            &tmp.path()
    ...
    fn records_superhigh_messages_without_rescanning() {
        ...
        record_superhigh_message(
            &db,
            "把 D:\\示例项目\\示例项目目录名服务端\\plugins 打开",
            "2026-08-23T10:00:00.000Z",
            Some(r"D:\示例项目\示例项目目录名服务端\plugins"),
            "session-1",
        )
        .unwrap();
