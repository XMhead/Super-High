...
describe('TerminalPane', () => {
  ...
  it('shows only the server and client start actions in the local terminal toolbar', async () => {
    const store = useWorkspaceStore()
    ...
    expect(labels).toEqual(['启动服务端', '启动客户端'])
  ...
  it('keeps DSH frame output out of the Codex scrollback renderer', async () => {
    const store = useWorkspaceStore()
    store.terminalSessions = [
      { id: 'session-dsh', title: 'DeepSeek Harness', providerKind: 'dsh', cwd: 'D:/Demo Files' },
    ]
  ...
  it.skip('shows a preview popup and completes the newest unique user input on Tab', async () => {
    ...
    store.terminalSessions = [
      { id: 'session-main', title: 'Codex', providerKind: 'codex', cwd: 'D:/Demo Files' },
      { id: 'session-claude', title: 'Claude', providerKind: 'claude', cwd: 'D:/Demo Files' },
      { id: 'session-dragon', title: 'DSH', providerKind: 'dsh', cwd: 'D:/Demo Files' },
    ]
    store.dragonCliSessionIds = ['session-dragon']
    store.activeTerminalSessionId = 'session-main'
    store.activeCliSessionId = 'session-main'
  ...
  it('pastes five clipboard images into CLI draft attachments and sends all paths', async () => {
    ...
    expect(store.sendTerminalConversationMessage).toHaveBeenCalledWith(
      'session-main',
      '[[superhigh-image path="D:/Demo Files/.superhigh/pasted-images/image-1.png"]]\n'
        + '[[superhigh-image path="D:/Demo Files/.superhigh/pasted-images/image-2.png"]]\n'
        + '[[superhigh-image path="D:/Demo Files/.superhigh/pasted-images/image-3.png"]]\n'
        + '[[superhigh-image path="D:/Demo Files/.superhigh/pasted-images/image-4.png"]]\n'
        + '[[superhigh-image path="D:/Demo Files/.superhigh/pasted-images/image-5.png"]]',
    )
