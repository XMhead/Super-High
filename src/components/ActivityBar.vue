...
import { FileCode2, Files, GitBranch, MessageSquare, Network, Puzzle, RadioTower, Settings, TerminalSquare, User } from 'lucide-vue-next'
...
<template>
  <nav class="activity-bar" aria-label="活动栏">
    <button class="activity-button" title="账户">
      <User :size="17" />
    </button>
    <button
