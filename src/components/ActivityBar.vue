...
import { FileCode2, Files, Gamepad2, Image as ImageIcon, MessageSquare, Network, Puzzle, RadioTower, Settings, TerminalSquare } from 'lucide-vue-next'
...
<template>
  <nav class="activity-bar" aria-label="活动栏">
    ...
    <button
      class="activity-button"
      :class="{ active: !store.settingsOpen && store.activeWorkspaceSurface === 'dragon' }"
      title="画布"
