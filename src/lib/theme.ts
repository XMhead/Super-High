...
// OpenCode themes (anomalyco/opencode)
  ...
  'opencode-catppuccin-frappe-dark': {
    id: 'opencode-catppuccin-frappe-dark',
    name: 'Catppuccin Frappé Dark',
    type: 'dark',
    colors: {
      bg: { primary: "#303446", secondary: "#292c3c", tertiary: "#232634", hover: "#313445" },
      text: { primary: "#c6d0f5", secondary: "#949cb8", muted: "#666c84" },
      accent: { blue: "#f4b8e4", green: "#a6d189", yellow: "#e5c890", red: "#e78284", purple: "#81c8be" },
      border: "#414559",
      inputBg: "#292c3c",
    },
    terminal: {
      background: "#303446", foreground: "#c6d0f5", cursor: "#f4b8e4",
      black: "#292c3c", red: "#e78284", green: "#a6d189", yellow: "#e5c890",
      blue: "#f4b8e4", magenta: "#81c8be", cyan: "#cdc5b7", white: "#c6d0f5",
      brightBlack: "#666c84", brightRed: "#dd99a6", brightGreen: "#b0d1a9", brightYellow: "#dccaae",
      brightBlue: "#e6bfe9", brightMagenta: "#96cacf", brightCyan: "#cdc5b7", brightWhite: "#c6d0f5",
    },
  },
  'opencode-catppuccin-frappe-light': {
    id: 'opencode-catppuccin-frappe-light',
    name: 'Catppuccin Frappé Light',
    type: 'light',
    colors: {
      bg: { primary: "#303446", secondary: "#292c3c", tertiary: "#232634", hover: "#313445" },
      text: { primary: "#c6d0f5", secondary: "#949cb8", muted: "#666c84" },
  ...
  'opencode-catppuccin-macchiato-dark': {
    id: 'opencode-catppuccin-macchiato-dark',
    name: 'Catppuccin Macchiato Dark',
    type: 'dark',
    colors: {
      bg: { primary: "#24273a", secondary: "#1e2030", tertiary: "#181926", hover: "#262838" },
      text: { primary: "#cad3f5", secondary: "#939ab7", muted: "#60657e" },
      accent: { blue: "#f5bde6", green: "#a6da95", yellow: "#eed49f", red: "#ed8796", purple: "#8bd5ca" },
      border: "#363a4f",
      inputBg: "#1e2030",
    },
    terminal: {
      background: "#24273a", foreground: "#cad3f5", cursor: "#f5bde6",
      black: "#1e2030", red: "#ed8796", green: "#a6da95", yellow: "#eed49f",
      blue: "#f5bde6", magenta: "#8bd5ca", cyan: "#ceccbe", white: "#cad3f5",
      brightBlack: "#60657e", brightRed: "#e39eb3", brightGreen: "#b1d8b2", brightYellow: "#e3d4b9",
      brightBlue: "#e8c4eb", brightMagenta: "#9ed4d7", brightCyan: "#ceccbe", brightWhite: "#cad3f5",
    },
  },
  'opencode-catppuccin-macchiato-light': {
    id: 'opencode-catppuccin-macchiato-light',
  ...
  'opencode-catppuccin-dark': {
    id: 'opencode-catppuccin-dark',
    name: 'Catppuccin Dark',
    type: 'dark',
    colors: {
      bg: { primary: "#1e1e2e", secondary: "#181825", tertiary: "#11111b", hover: "#1f202d" },
      text: { primary: "#cdd6f4", secondary: "#9399b2", muted: "#5d6076" },
      accent: { blue: "#f5c2e7", green: "#a6e3a1", yellow: "#f9e2af", red: "#f38ba8", purple: "#94e2d5" },
      border: "#313244",
      inputBg: "#181825",
    },
    terminal: {
      ...
      blue: "#f5c2e7", magenta: "#94e2d5", cyan: "#ced3c4", white: "#cdd6f4",
      brightBlack: "#5d6076", brightRed: "#e8a2bf", brightGreen: "#b2dfba", brightYellow: "#ecdec4",
      brightBlue: "#e9c8eb", brightMagenta: "#a5dede", brightCyan: "#ced3c4", brightWhite: "#cdd6f4",
    },
  },
  ...
  'opencode-dracula-dark': {
    id: 'opencode-dracula-dark',
    name: 'Dracula Dark',
    type: 'dark',
    colors: {
      bg: { primary: "#282a36", secondary: "#21222c", tertiary: "#44475a", hover: "#44475a" },
      text: { primary: "#f8f8f2", secondary: "#6272a4", muted: "#525a7b" },
      accent: { blue: "#8be9fd", green: "#50fa7b", yellow: "#f1fa8c", red: "#ff5555", purple: "#ffb86c" },
      border: "#44475a",
      inputBg: "#21222c",
    },
    terminal: {
      background: "#282a36", foreground: "#f8f8f2", cursor: "#8be9fd",
      black: "#21222c", red: "#ff5555", green: "#50fa7b", yellow: "#f1fa8c",
      blue: "#8be9fd", magenta: "#ffb86c", cyan: "#6ef2bc", white: "#f8f8f2",
      brightBlack: "#525a7b", brightRed: "#fd8684", brightGreen: "#82f99f", brightYellow: "#f3f9ab",
      brightBlue: "#aceefa", brightMagenta: "#fdcb94", brightCyan: "#6ef2bc", brightWhite: "#f8f8f2",
    },
  },
  ...
  'opencode-material-light': {
    id: 'opencode-material-light',
    name: 'Material Light',
    type: 'light',
    colors: {
      bg: { primary: "#fafafa", secondary: "#f5f5f5", tertiary: "#e7e7e8", hover: "#e4e4e4" },
      text: { primary: "#263238", secondary: "#90a4ae", muted: "#bcc5ca" },
      accent: { blue: "#39adb5", green: "#91b859", yellow: "#ffb300", red: "#e53935", purple: "#f4511e" },
      border: "#e0e0e0",
      inputBg: "#f5f5f5",
    },
    terminal: {
      background: "#fafafa", foreground: "#263238", cursor: "#39adb5",
      black: "#f5f5f5", red: "#e53935", green: "#91b859", yellow: "#ffb300",
      blue: "#39adb5", magenta: "#f4511e", cyan: "#65b387", white: "#263238",
      brightBlack: "#bcc5ca", brightRed: "#ac3736", brightGreen: "#71904f", brightYellow: "#be8c11",
      brightBlue: "#338890", brightMagenta: "#b64826", brightCyan: "#65b387", brightWhite: "#263238",
    },
  },
  ...
  'opencode-nightowl-dark': {
    id: 'opencode-nightowl-dark',
    name: 'Night Owl Dark',
    type: 'dark',
    colors: {
      bg: { primary: "#011627", secondary: "#0b253a", tertiary: "#0b253a", hover: "#314d64" },
      text: { primary: "#d6deeb", secondary: "#5f7e97", muted: "#5f7e97" },
      accent: { blue: "#c792ea", green: "#c5e478", yellow: "#ecc48d", red: "#EF5350", purple: "#82AAFF" },
      border: "#5f7e97",
      inputBg: "#0b253a",
    },
    terminal: {
      background: "#011627", foreground: "#d6deeb", cursor: "#c792ea",
      black: "#0b253a", red: "#EF5350", green: "#c5e478", yellow: "#ecc48d",
      blue: "#c792ea", magenta: "#82AAFF", cyan: "#c6bbb1", white: "#d6deeb",
      brightBlack: "#5f7e97", brightRed: "#e87d7f", brightGreen: "#cae29b", brightYellow: "#e5cca9",
      brightBlue: "#cca9ea", brightMagenta: "#9bbaf9", brightCyan: "#c6bbb1", brightWhite: "#d6deeb",
    },
  },
  'opencode-nightowl-light': {
    id: 'opencode-nightowl-light',
  ...
  'opencode-nord-dark': {
    id: 'opencode-nord-dark',
    name: 'Nord Dark',
    type: 'dark',
    colors: {
      bg: { primary: "#2E3440", secondary: "#3B4252", tertiary: "#434C5E", hover: "#434c5e" },
      text: { primary: "#ECEFF4", secondary: "#8B95A7", muted: "#636d7f" },
      accent: { blue: "#8FBCBB", green: "#A3BE8C", yellow: "#D08770", red: "#BF616A", purple: "#88C0D0" },
      border: "#434C5E",
      inputBg: "#3B4252",
    },
    terminal: {
      background: "#2E3440", foreground: "#ECEFF4", cursor: "#8FBCBB",
      black: "#3B4252", red: "#BF616A", green: "#A3BE8C", yellow: "#D08770",
      blue: "#8FBCBB", magenta: "#88C0D0", cyan: "#99bda4", white: "#ECEFF4",
      brightBlack: "#636d7f", brightRed: "#cd8c93", brightGreen: "#b9cdab", brightYellow: "#d8a698",
      brightBlue: "#abcbcc", brightMagenta: "#a6cedb", brightCyan: "#99bda4", brightWhite: "#ECEFF4",
    },
  },
  'opencode-nord-light': {
  ...
  'opencode-one-dark-dark': {
    id: 'opencode-one-dark-dark',
    name: 'One Dark Dark',
    type: 'dark',
    colors: {
      bg: { primary: "#282c34", secondary: "#21252b", tertiary: "#353b45", hover: "#373d47" },
      text: { primary: "#abb2bf", secondary: "#5c6370", muted: "#494f5b" },
      accent: { blue: "#56b6c2", green: "#98c379", yellow: "#e5c07b", red: "#e06c75", purple: "#d19a66" },
      border: "#393f4a",
      inputBg: "#21252b",
    },
    terminal: {
      background: "#282c34", foreground: "#abb2bf", cursor: "#56b6c2",
      black: "#21252b", red: "#e06c75", green: "#98c379", yellow: "#e5c07b",
      blue: "#56b6c2", magenta: "#d19a66", cyan: "#77bd9e", white: "#abb2bf",
      brightBlack: "#494f5b", brightRed: "#d0818b", brightGreen: "#9ebe8e", brightYellow: "#d4bc8f",
      brightBlue: "#70b5c1", brightMagenta: "#c6a181", brightCyan: "#77bd9e", brightWhite: "#abb2bf",
    },
  },
  ...
  'opencode-palenight-light': {
    id: 'opencode-palenight-light',
    name: 'Palenight Light',
    type: 'light',
    colors: {
      bg: { primary: "#fafafa", secondary: "#f5f5f5", tertiary: "#e7e7e8", hover: "#e4e4e4" },
      text: { primary: "#292d3e", secondary: "#8796b0", muted: "#b8bfca" },
      accent: { blue: "#00acc1", green: "#91b859", yellow: "#ffb300", red: "#e53935", purple: "#f4511e" },
      border: "#e0e0e0",
      inputBg: "#f5f5f5",
    },
    terminal: {
      background: "#fafafa", foreground: "#292d3e", cursor: "#00acc1",
      black: "#f5f5f5", red: "#e53935", green: "#91b859", yellow: "#ffb300",
      blue: "#00acc1", magenta: "#f4511e", cyan: "#49b28d", white: "#292d3e",
      brightBlack: "#b8bfca", brightRed: "#ad3538", brightGreen: "#728e51", brightYellow: "#bf8b13",
      brightBlue: "#0c869a", brightMagenta: "#b74628", brightCyan: "#49b28d", brightWhite: "#292d3e",
    },
  },
