...
export const CLI_PROVIDER_OPTIONS: CliProviderOption[] = [
  ...
  { id: 'dsh', name: 'dsh-tui', shortName: 'dsh-tui', command: 'dsh', icon: 'terminal' },
]

export const CLI_PROVIDER_LAUNCH_ENABLED = { dsh: false } as const

export function cliProviderLaunchEnabled(providerKind: string): boolean {
  return providerKind !== 'dsh' || CLI_PROVIDER_LAUNCH_ENABLED.dsh
}
