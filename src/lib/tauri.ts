...
export const backend = {
  ...
  normalizePromptSpacing(prompt: string) {
    return command<string>('normalize_prompt_spacing_command', { prompt })
  },
  promptSpacingStatus() {
    return command<{ ready: boolean }>('prompt_spacing_status_command')
  },
  installPromptSpacing() {
    return command<void>('install_prompt_spacing_command')
  },
