  ...
  <main class="mobile-app">
    ...
    <template v-if="drawerOpen">
      ...
      <aside :inert="settingsOpen" class="mobile-drawer" aria-label="工作区资源管理器">
        ...
        </section>    <section v-if="connected && activeProject && !projectPickerOpen" ref="treeScroller" class="mobile-section project-browser" @scroll="treeScrollTop = ($event.target as HTMLElement).scrollTop">
