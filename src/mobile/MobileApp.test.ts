...
vi.mock('./MobileSessions.vue', () => ({ default: { props: ['root', 'connected', 'api'], template: '<div class="test-terminal" :data-root="root" :data-connected="connected"><button class="probe-active-host" @click="api.status()">Probe</button></div>' } }))
