...
export interface DragonCoreInfo {
  appRootPath: string
  dragonCorePath: string
  configPath: string
  outputPath: string
...
export type WorkspaceSurfaceKind = 'project' | 'editor' | 'docs' | 'scripts' | 'dragon' | 'minecraft' | 'files' | 'channels'
...
export type TerminalProviderKind = 'local' | 'minecraft-client' | 'claude' | 'codex' | 'kimi' | 'grok' | 'gemini' | 'opencode' | 'dsh'
