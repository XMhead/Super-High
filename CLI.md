...
```powershell
superhigh-cli service status --project "D:\MyProject" --json
superhigh-cli service start --project "D:\MyProject" --service app --json
superhigh-cli service restart --project "D:\MyProject" --service app --json
```
